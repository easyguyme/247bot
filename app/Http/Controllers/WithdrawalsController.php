...
class WithdrawalsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->only('telegram_username', 'telegram_id','username', 'amount','account_no','account_name');
...
//        dd($id);
        ...
        $client = Withdrawals::where('id',$id)->first();
...
// Message text
            $message = 'Congratulations your withdrawal request is successful';
