...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('approve/client/{id}', [ClientController::class,'approve']);
    Route::get('reject/client/{id}', [ClientController::class,'reject']);
    Route::get('approve/deposit/{id}', [DepositsController::class,'approve']);
    Route::get('reject/deposit/{id}', [DepositsController::class,'reject']);
    Route::get('approve/withdraw/{id}', [WithdrawalsController::class,'approve']);
    Route::get('reject/withdraw/{id}', [WithdrawalsController::class,'reject']);
    Route::get('approve/recovery/{id}', [RecoveryController::class,'approve']);
    Route::get('reject/recovery/{id}', [RecoveryController::class,'reject']);
    ...
    Route::get('/recoveries', [HomeController::class,'recoveries'])->name('recoveries');
